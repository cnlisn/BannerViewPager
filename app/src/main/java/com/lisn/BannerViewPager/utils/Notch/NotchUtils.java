package com.lisn.BannerViewPager.utils.Notch;
...
public class NotchUtils {
     ...
     * @return
     */
    public static int getNotHeightAtMeiZu(Context context) {
        int result = 0;
     ...
     * @return
     */
    public static int getNotWidthAtMeiZu(Context context) {
        int result = 0;
    ...
    /**
     * MeiZu手机获取默认和隐藏刘海区开关值
     *
     * @param context
     * @return false表示“默认”，true表示“隐藏显示区域”
     */
    public static boolean getIsNotchSwitchOpenAtMeiZu(Context context) {
